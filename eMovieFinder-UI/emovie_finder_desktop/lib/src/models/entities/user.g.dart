...
User _$UserFromJson(Map<String, dynamic> json) => User(
      ...
      combinedRoles: json['combinedRoles'] as String?,
      identityUser: json['identityUser'] == null
          ? null
          : IdentityUser.fromJson(json['identityUser'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$UserToJson(User instance) => <String, dynamic>{
      ...
      'combinedRoles': instance.combinedRoles,
      'identityUser': instance.identityUser,
    };
